...
import { SectionSeperator, SectionSubTitle, SectionTitle, SectionWrapper } from "@/components/section-items";
import { Button } from "@/components/ui/button";
import { PROJECTS } from "@/data/project";

import { ProjectCard } from "./project-card";

export const Projects = ({ showViewAll = false, limit }: { showViewAll?: boolean; limit?: number }) => {
